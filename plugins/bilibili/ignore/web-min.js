!function(e, t) {
      ...
      , H = function(e) {
        ...
        function r() {
            ...
            for (var n = arguments.length, o = new Array(n), i = 0; i < n; i++)
                o[i] = arguments[i];
            return c(p(e = t.call.apply(t, [this].concat(o))), "handler", M),
    ...
    var G = function(e) {
      ...
      , re = function() {
        var e = i(r().mark((function e(o, i) {
            var a, u, s, c, l, f, d, p, h, v, b, m, w, x, _, k, E, O;
            return r().wrap((function(e) {
                for (; ; )
                    switch (e.prev = e.next) {
                    case 0:
            ...
            return r().wrap((function(e) {
                for (; ; )
                    ...
                    case 13:
                        return e.abrupt("return", e.sent);
                    case 14:
                        ve("application/x-www-form-urlencoded", l) && (t.request.data = V("", f).slice(1)),
                        ve("application/json", l || "application/json") && ye(t, f, l),
                        ve("multipart/form-data", l) && (d = Object.keys(f)).length && (t.request.data = d.reduce((function(e, t) {
            ...
            return r().wrap((function(e) {
                for (; ; )
                    ...
                    case 2:
                        ...
                        ,
                        "GET" === a ? !0 === l.params && v("params") : "POST" !== a && "PUT" !== a || (y = ee(s) || "",
                        void 0 === l.data && void 0 === l.params ? y ? ve(he.JSON, y) ? v("params") : v("data") : void 0 === u || X(u) ? v("params") : v("data") : (l.params && v("params"),
                        l.data && (void 0 === u && (ve(he.FormData, y) ? t.request.data = new FormData : t.request.data = {}),
                        v("data")))),
                        e.next = 12,
                        n();
                    case 12:
      ...
      , yt = function(e, t) {
        ...
        try {
            if ("string" == typeof e)
                try {
                    var r = JSON.parse(e);
                    return "object" === n(r) && null !== r ? vt(r, t) : {}
                } catch (e) {
                    return console.error(e),
                    {}
                }
            ...
            return r().wrap((function(e) {
                for (; ; )
                    ...
                    case 8:
                        ...
                        l = t.request.data ? ht(yt(t.request.data, null == o || null === (i = o.payload) || void 0 === i ? void 0 : i.bodyPayload), null !== (a = null == o || null === (u = o.payload) || void 0 === u ? void 0 : u.bodyPrefix) && void 0 !== a ? a : "w_") : {},
    ...
    var St = function(e, t) {
        var r, n = e || "", o = t;
        "undefined" != typeof window && (n = n || navigator.userAgent,
        o = o || (null === (r = document.getElementsByTagName("meta").spm_prefix) || void 0 === r ? void 0 : r.content) || "0.0");
        var i = At(n);
        return {
            device: i.device,
            spmid: o,
      ...
      , At = function(e) {
        ...
        return e ? e.indexOf("bilibili_pc") > 0 ? (t.device = "pc",
        t.mobiapp = "pc_electron",
        t) : e.indexOf("pad") > 0 ? (t.device = "pad",
        t) : e.indexOf("Android") > 0 || e.indexOf("Phone") > 0 ? (t.device = "phone",
        t) : e.indexOf("Mozilla") >= 0 ? (t.device = "pc",
        t) : t : (t.device = "pc",
        t)
    }
      , Ct = function() {
            ...
            return r().wrap((function(e) {
                for (; ; )
                    ...
                    case 3:
                        return e.abrupt("return", e.sent);
                    case 4:
                        return t.request && (a = Object.assign({}, St(null === (i = t.request) || void 0 === i || null === (i = i.headers) || void 0 === i ? void 0 : i.userAgent), null == o ? void 0 : o.payload),
                        u = a.device,
                        s = a.spmid,
                        c = a.fromSpmid,
                        l = a.mobiApp,
                        ...
                        c && (f.from_spmid = c),
                        l && (f.mobi_app = l),
                        t.request.params || (t.request.params = {}),
                        t.request.params["x-bili-device-req-json"] = JSON.stringify(f)),
                        e.next = 7,
                        n();
                    case 7:
                    case "end":
                    ...
                    return i(r().mark((function i() {
                        ...
                        return r().wrap((function(r) {
                            for (; ; )
                                ...
                                case 0:
                                    return a = (null == o ? void 0 : o.payload) || {
    ...
    function Nt(e, t) {
        this.service = new e({
            ...
            }), new Bt, new Ut, new Lt].concat(b((null == t ? void 0 : t.middlewares) || []))
        })
    }
    function Ft(e, t) {
        var r;
    ...
    function Kt(e, t, r) {
        return Ft(t, (function(t, n) {
            e[n] = r && "function" == typeof t ? Mt(t, r) : t
        }
        )),
        e
    }
    ...
    Nt.prototype.request = function(e) {
        var t = this.service;
        if (e.chainProxy)
            try {
    ...
    ,
    Nt.prototype.get = function(e, r) {
        return this.request(t(t({}, r || {}), {}, {
            url: e
        }))
    }
    ,
    Nt.prototype.post = function(e, r, n) {
        ...
        var e = i(r().mark((function e() {
            ...
            return r().wrap((function(e) {
                for (; ; )
                    ...
                    case 3:
                        return e.next = 5,
                        Gt("//s1.hdslb.com/bfs/seed/jinkela/risk-captcha-sdk/CaptchaLoader.js");
                    case 5:
                                ...
                                return i(r().mark((function i() {
                                    ...
                                    return r().wrap((function(r) {
                                        for (; ; )
                                            switch (r.prev = r.next) {
                                            case 0:
                                                if ("object" !== n(a) || (null == a ? void 0 : a.event) !== Yt) {
                                                    r.next = 9;
                                                    break
                                                }
                                            ...
                                            case 5:
                                                ...
                                                (p || null !== (f = Jt(o, "APP_RUNTIME")) && void 0 !== f && f.version) && (e.headers = t(t({}, e.headers || {}), {}, c({}, "x-bili-gaia-vtoken", u))))),
                                                r.abrupt("return", e);
                                            case 9:
                                                if (!y) {
                                                    r.next = 13;
    ...
    c($t, "handler", Vt);
    var Zt = "undefined" != typeof globalThis ? globalThis : "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {};
    function Qt(e) {
        return function(e, t) {
            var r = new Nt(e,t)
              , n = Mt(Nt.prototype.request, r);
            return Kt(n, Nt.prototype, r),
            Kt(n, r),
            n
        }($e, t(t({}, e || {}), {}, {
            middlewares: [new $t]
